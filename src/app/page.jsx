...
export default function BlogPage() {
  ...
  return (
    <div
      className={`min-h-screen transition-colors duration-300 ${darkMode ? "dark bg-gray-950" : "bg-gray-100"
        }`}
    >
      {/* <nav
            ...
            <div className="flex items-center space-x-4">
              <div className="relative hidden sm:block">
                ...
                <input
                  ...
                  className={`pl-10 pr-4 py-2 w-64 rounded-lg border transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent ${darkMode
            ...
            <div className="px-4 sm:px-6">
              <div className="relative mb-4">
                ...
                <input
                  ...
                  value={searchTerm}
                  onChange={(e) => setSearchTerm(e.target.value)}
                  className={`pl-10 pr-4 py-2 w-full rounded-lg border transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent ${darkMode
                      ? "bg-gray-800 border-gray-700 text-gray-200 placeholder-gray-500"
                      : "bg-white border-gray-200 text-gray-900 placeholder-gray-400"
                    }`}
                />
              ...
              <Link
                href="/"
                className={`block px-4 py-2 rounded-md text-base font-medium ${darkMode ? "text-gray-200" : "text-gray-700"
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <section className="mb-8">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 space-y-4 sm:space-y-0">
            ...
            <h2
              className={`text-2xl font-bold font-playfair ${darkMode ? "text-gray-100" : "text-gray-900"
                }`}
            >
              Latest Articles
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[...Array(6)].map((_, i) => (
                <div key={i} className="animate-pulse">
                  <div
                    className={`rounded-xl h-48 mb-4 ${darkMode ? "bg-gray-800" : "bg-gray-200"
                      }`}
                  />
                  <div
                    className={`h-4 rounded mb-2 ${darkMode ? "bg-gray-800" : "bg-gray-200"
                      }`}
                  />
                  <div
                    className={`h-4 rounded mb-2 w-3/4 ${darkMode ? "bg-gray-800" : "bg-gray-200"
                      }`}
                  />
                  <div
                    className={`h-3 rounded w-1/2 ${darkMode ? "bg-gray-800" : "bg-gray-200"
                      }`}
                  />
                </div>
              ))}
